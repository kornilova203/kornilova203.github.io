var images = document.querySelectorAll('.img-container img'); //array of images
var widthOfContainer;
var heightOfContainer;
var heightOfImg; //height of image is bigger than height of container

if(!mobileAndTabletcheck()) //если мы с компа, то изображение должно немного прокручиваться
...
else { //for mobiles make resize only if orientation was changed
