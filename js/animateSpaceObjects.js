...
function createPlanets(amount) {
  angle = 360/amount;
  var newArr = [];
  newArr.push(new Ball (planetsImgs[0], 40*sizeCoef, m))
  newArr[0].pos2D = new Vector2D(vw/2,vh/2-distanceToSun);
  var v = Math.sqrt(G*M*m/distanceToSun)*0.75; //velocity for circular orbit
